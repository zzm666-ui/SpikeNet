...
def parse_args():
    ...
    parser.add_argument('--model', default='SpikeNet', help='model name [default: pointnet_cls]')
...
def main():
    ...
    if device == 'cuda':
        ...
        # input_t = torch.randn(1,3,1024)
        # input_t = input_t.to(device)
        # flops,params = get_model_complexity_info(net,(3,1024),as_strings=True,print_per_layer_stat=True)
